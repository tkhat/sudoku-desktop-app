package com.example.javasudokuapp.computation_logic;

import com.example.javasudokuapp.constants.GameState;
import com.example.javasudokuapp.constants.Rows;
...
import static com.example.javasudokuapp.problems.SudokuGame.GRID_BOUNDARY;
...
public class GameLogic {
    ...
    private static boolean rowsAreInvalid(int[][] grid) {
        for (int yIndex = 0; yIndex < GRID_BOUNDARY; yIndex++){
            ...
            if (collectionHasRepeates(row)) return true;
        }
        return false;
    }
    ...
    private static boolean squareIsInvalid(int xIndex, int yIndex, int[][] grid) {
        ...
        if (collectionHasRepeates(square)) return true;
        return false;
    }

    private static boolean collectionHasRepeates(List<Integer> collection) {
